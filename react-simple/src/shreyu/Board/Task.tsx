        ...
        <Card.Body className="p-3">
          <Dropdown className="float-end" align="end">
            <Dropdown.Toggle as="a" className="cursor-pointer text-muted arrow-none">
              <i className="uil uil-ellipsis-v fs-14" />
            </Dropdown.Toggle>

            <Dropdown.Menu>
              <Dropdown.Item>
                <i className="uil uil-edit-alt me-2" />
                Edit
              </Dropdown.Item>
              <Dropdown.Item>
                <i className="uil uil-user-plus me-2" />
                Add People
              </Dropdown.Item>
              <Dropdown.Item className="text-warning">
                <i className="uil uil-exit me-2" />
                Leave
              </Dropdown.Item>
              <Dropdown.Divider />
              <Dropdown.Item className="text-danger">
                <i className="uil uil-trash me-2" />
                Delete
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          ...
          <p className="mb-0 mt-4">
            <span className="text-nowrap align-middle fs-13 me-2">
              <i className="uil uil-comments-alt text-muted me-1" />
              {task.totalComments}
            </span>

            <span className="text-nowrap align-middle fs-13">
              <i className="uil uil-check-square me-1 text-muted" />
